...
web build:
 - http://mootools.net/core/015f1d40b89a2cbcc641ffe32bd41ca4

packager build:
 - packager build Core/Array Core/Object Core/Element Core/Element.Style Core/Element.Event Core/Fx.Tween
...
}var b=[];for(var a=0;a<3;a++){var c=(this[a]-0).toString(16);b.push((c.length==1)?"0"+c:c);}return(d)?b:"#"+b.join("");}});(function(){var a=Object.prototype.hasOwnProperty;
...
}});return d.join("&");}});})();Function.extend({attempt:function(){for(var b=0,a=arguments.length;b<a;b++){try{return arguments[b]();}catch(c){}}return null;
